...
**Scope:** v0 capability list, response envelope, failure modes, and compliance expectations
...
### 3.3 `get_change_summary`

Summarize recent changes for a topic or time range.

### 3.4 `report_declared_vs_observed_drift`
...
- `get_temporal_blast_radius`
- `trace_supersession`
- `report_contradictions`
- `federate_dependency_beacons`
